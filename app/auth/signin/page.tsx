...
function SignInContent() {
  ...
  const errorMessages: Record<string, string> = {
    Configuration: 'Server configuration error. Check that all environment variables are set in Vercel.',
    ...
    <>
      ...
      <div className="signin-page" style={{ position: 'relative', zIndex: 1 }}>
        <div className="signin-card">
          ...
          {error && (
            <div style={{ background: 'rgba(248,113,113,0.08)', border: '1px solid rgba(248,113,113,0.25)', borderRadius: 10, padding: '10px 14px', marginBottom: 20, fontSize: 11, color: 'var(--red)', fontFamily: 'var(--mono)', lineHeight: 1.6 }}>
